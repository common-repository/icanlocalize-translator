        ...
        <tbody>
            <tr valign="top">
                ...
                <td>
                    ...
                    <?php if(isset($e)) echo '<b>'. __('Error:') . '</b> ' . ucfirst($e) . '.&nbsp;'?><?php echo __('Need help? Visit'); ?> <a href="http://sitepress.org/wordpress-translation/using-icanlocalize-translator/">ICanLocalize Translation Getting Started Guide</a>.
                    </div>                
                </td>
            </tr>                    
            <tr valign="top">
